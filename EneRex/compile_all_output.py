...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--jsonFilesPath", default="data/JSONs", help="path to the input JSON files"
    )
    parser.add_argument(
        "--feature12Path",
        default="feature12/output/transformer",
        help="path to output of feature12",
    )
    parser.add_argument(
        "--feature345Path",
        default="feature345/outputSingleMode",
        help="path to output of feature345",
    )
    ...
    with open(
        Path.cwd().joinpath(feature345Path, "sentences_task_app_method.json"), "r"
    ) as f:
